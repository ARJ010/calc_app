...
class AdvocateAdmin(admin.ModelAdmin):
    list_display = ('user', 'enrolment_no', 'bar_registration', 'kawf_no', 'mobile_number', 'due_amount')
    search_fields = ('user__first_name', 'user__last_name', 'enrolment_no', 'bar_registration', 'kawf_no')
...
class PaymentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('serial_number', 'advocate__enrolment_no', 'advocate__bar_registration')
...
class MonthlyPaymentDueAdmin(admin.ModelAdmin):
    ...
    search_fields = ('advocate__enrolment_no', 'advocate__bar_registration')
